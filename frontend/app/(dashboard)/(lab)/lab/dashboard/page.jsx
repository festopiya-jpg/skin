    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900 flex items-center gap-2">
          <Microscope className="text-rose-600 w-8 h-8" />
          Lab Technician Dashboard
        </h1>
        <p className="text-gray-500 mt-1">Manage doctor-approved lab test orders.</p>
      </div>

      <div className="glass-card rounded-2xl overflow-hidden mt-6">
        <div className="p-6 border-b border-gray-200/50 flex justify-between items-center">
          <h2 className="text-xl font-bold text-gray-900">Pending Lab Tests</h2>
        </div>
        <div className="overflow-x-auto p-4">
          {queue.length === 0 ? (
            <div className="text-center py-10">
              <Clock className="w-12 h-12 text-gray-400 mx-auto mb-3 opacity-50" />
              <p className="text-gray-500 font-medium">No pending lab orders.</p>
            </div>
          ) : (
